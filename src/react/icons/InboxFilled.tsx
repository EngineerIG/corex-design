...
export interface InboxFilledProps extends React.SVGProps<SVGSVGElement> {
  size?: string | number;
}

const InboxFilled = React.forwardRef<SVGSVGElement, InboxFilledProps>(
  ({ size = 24, ...props }, ref) => (
...
InboxFilled.displayName = 'InboxFilled';
